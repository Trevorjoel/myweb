...
switch ($winner) {
	...
	case 'Your Mum' :
		'Your Mum';
		print ('<article id="articleform_awards"><IMG SRC="images/yourmum.jpg" ALT="Enjoy" WIDTH=332 HEIGHT=332><p>Thats right, YOUR mum, yes YOURS! Little do you 
...
?>
 <br>
		<input class="button" type="button" value="PLAY AGAIN!"
